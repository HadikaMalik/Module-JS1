const penceString = "399p"; //this defines the value of the pence in a string 
...
const paddedPenceNumberString = penceStringWithoutTrailingP.padStart(3, "0"); // this means it will add a character or value to the string until it reaches the length required
...
const pence = paddedPenceNumberString
  ...
  // padend means it will add the specified character starting from the end until it reaches the desired number

console.log(`£${pounds}.${pence}`); // this will log the string value of pound and pence 
